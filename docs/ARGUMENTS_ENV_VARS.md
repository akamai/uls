...
| Parameter                 | Env - Var       | Options                                                                                                                                                                                                                 | Default       | Description                                                                                                                                                                                 |
|---------------------------|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -i <br> --input           | ULS_INPUT       | 'EAA', 'ETP', 'GC', 'LINODE', 'ACC'                                                                                                                                                                               | None          | Specify the desired INPUT source                                                                                                                                                            |
| --feed                    | ULS_FEED        | EAA: 'ACCESS', 'ADMIN', 'CONHEALTH', 'DEVINV'<br><br> ETP: 'THREAT', 'AUP', 'DNS', 'PROXY'<br><br> GC: 'NETLOG', 'INCIDENT', 'AGENT', 'SYSTEM', 'AUDIT'<br><br> LINODE: 'AUDIT'<br><br> ACC: 'EVENTS' | None          | Specify the desired INPUT feed                                                                                                                                                              |
...
|-----------------------|-------------|---------------------------|------------------------------------------------------------|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -o <br> --output      |             | ULS_OUTPUT                | 'TCP', 'UDP', 'HTTP', 'RAW', 'FILE', 'NONE'                | None                     | Specify the desired OUTPUT target                                                                                                                                                                                                                                                                 |
 |                       |             |                           |                                                            |                          |
...
| --httpaddheader       | HTTP(S)     | ULS_HTTP_ADD_HEADER       | '{"X-MY-HEADER1": "HEADER1", "X-MY-HEADER2": "HEADER2"}'   | None                     | Specify additional headers to be sent with the HTTP request (HTTP only) <br>Example:<br>'{"X-MY-HEADER1": "HEADER1", "X-MY-HEADER2": "HEADER2"}'                                                                                                                                                  |
...
| --httpcompression     | HTTP(S)     | ULS_HTTP_COMPRESSION      | True, False                                                | False                    | Enable compression for the HTTP payload (Compression type can be selected via ULS_HTTP_COMPRESSION_TYPE )                                                                                                                                                                                         |
| --httpcompressiontype | HTTP(S)     | ULS_HTTP_COMPRESSION_TYPE | 'GZIP','BROTLI'                                            | GZIP                     | HTTP compression method to align with the receiving server                                                                                                                                                                                                                                        |
|                       |             |                           |                                                            |                          |                                                                                                                                                                                                                                                                                                   | 
